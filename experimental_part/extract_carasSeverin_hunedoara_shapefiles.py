...
cluj_alba = counties[counties['NAME_1'].isin(['Caraș-Severin', 'Hunedoara'])]

# Save to a new file
cluj_alba.to_file("carasSeverin_hunedoara.gpkg", driver="GPKG")  # Save as GeoPackage
# Or, save as shapefile if necessary
cluj_alba.to_file("carasSeverin_hunedoara.shp")